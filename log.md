...
- 2026-06-09: 6/8 5시 뉴스 26건 ingest — 유가(WTI 88) 트럼프 합의 발언 하락 · 원달러 1,512원 급락 · 정유/화학 공급차질 분석 · 금리·환율 동반 안정


## 2026-06-10 한국금리 갱신
- 한국금리 페이지 스냅샷 히스토리 중복 대량 정리(2026-06-06 kihoilbo×asiae 동일값 30+행 → 1행 통합).
- 최신 스냅샷 갱신(2026-06-10 기준): 기준금리 2.50%, 국고3년 약 3.88~3.90%, 국고10년 약 4.20~4.25%.
- 스냅샷 히스토리: 2026-06-09~10 2행 추가.
- 셀사이드 전망: 판테온·BOJ 인상·美 CPI 4.2% 2행 추가.
- 최근 이벤트: 美 CPI 4.2%, BOJ 6월 인상, 임시 금통위, 신용대출 금리 6% 등 신규 블록 추가.
- 🐦SNS 인사이트(swpark0130, csu03102, richdo_invest, sosohanppy) 4건 추가.
- 출처: 블로그 뉴스 10건.


## 2026-06-10 ingest — 미래에셋증권 뉴스 26건 반영
- 미래에셋증권 개인투자용국채 6월 청약 실시
- 티엠씨 리포트 (북미 데이터센터 광통신)
- 중소기업퇴직연금기금 OCIO 재선정 (삼성운용·미래에셋증권)
- 카카오 특징주 — 목표가 하향
- 구다이글로벌 IPO 대표주관사 선정
- SPACEX D-2: ETF 유입·청약 완판
- 증권사 자기자본 양극화
- 퇴직연금 디지털 컨설팅 경쟁
- 서상영 연구원: 6/10 코스피 재급락 분석
- 금융 브리핑 (개인투자용국채)


2026-06-10 ingest: SK하이닉스 청주 화학물질 사고 / 최태원 차기 생산기지 검토 / 광주 패키징 공장 검토 / 주주단체 성과급 소송 / SKT-NTT AI 펀드 / HBM5 방열 경쟁 — 8개 페이지 갱신


- 2026-06-10: 미래에셋증권·증권·SpaceX 갱신, 신규 종목(텔레픽스·바로팜·어피닛·랩인큐브) 생성, macro 7종 스냅샷 N/A, 출처: dailian, 네이버블로그 25건


## 2026-06-11 스킵: 신규 뉴스에 투자·리서치 관련 콘텐츠 없음

제공된 네이버 블로그 25개는 모두 일반 쇼핑 후기(스파오키즈·넥스코에어컨·탁구라켓·닥터피엘·아이패드 등), 학원·헤어살롱·학습지 안내, 운세/타로, 일상 블로그 등으로, 셀사이드 리서치 위키(종목·섹터·테마·거시지표)와 관련 없는 생활·커머스 콘텐츠. ingest 생략.


#### 2026-06-13 15:00: 유가·美國금리·한국금리·원달러환율 — 미·이란 종전 MOU 서명 임박·WTI 84$ 급락 반영


2026-06-14: 현대차 ingest — 27건 뉴스 처리. 르망24시·美점유율·사우디PIF·N%성과급·포스코·한-이탈리아 외교·코스피 변동성. 현대차·자동차·로보틱스·자율주행 페이지 갱신.
