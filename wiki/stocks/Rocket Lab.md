...
- **Neutron·우주 인프라 확장**: 2026년 내 Neutron 첫 발사 대기. Electron+Photon+로봇 수직계열화 완료. 소형 발사체 독점 → 중형·군수·우주 데이터센터로 확장.
- **위험**: 연 매출 $8억 대비 시총 86.7배(적자). 스페이스X 상장 후 차익실현 압력. 나스닥100 리밸런싱 전 단기 변동성.
