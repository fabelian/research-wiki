...
- **Broadcom·Apple·SMCI 급락, AI 밸류에이션 재평가 국면**: Broadcom Q3 가이던스 쇼크 후 이틀간 -20% → AI 섹터 전반의 현실 자각. '모든 AI 주식이 오르던 시대 종료'. SMCI는 390억 달러 대규모 AI 서버 수주에도 고객 다각화·한계 M/S 리스크로 추가 급락(네이버블로그 머니대디·ucs73 2026-06-10).
- **5월 CPI 헤드라인 4.2% 발표, 단기 안도·장기 불확실성**: 3년 만 최고 CPI지만 근원 3.4% 예상 부합으로 '최악은 피했다' 해석. 나스닥·S&P500 단기 반응. 다만 4.2% 고물가 시그널 지속으로 AI·반도체주의 밸류에이션 부담 불완전 해소.
- **6/10 美 증시 3대 지수 하락 마감**: SOXX -3%+, Broadcom·AMD·Micron 5거래일 중 4거래일 하락. 중동 긴장 고조 부담. (디지털데일리 2026-06-10)
- **SMCI 390억 달러 주문 vs 추가 급락**: SMCI가 390억 달러 규모 AI 서버 주문 수주, 공급망으로 Broadcom·Marvell·Arista 네트워크·스위칭 수요 연계. 그러나 주가 5거래일 4일 하락 — 개별 악재와 분리 필요. (블로그 uc73 2026-06-10)
...
## 2026-06-08 업데이트 — '검은 월요일' 글로벌 확산·캐시 우드 매수

### 📉 '검은 월요일' 글로벌 확산 (연합뉴스·중앙일보)
- **코스피 8% 폭락·서킷브레이커 발동**, 시총 약 3,900억 달러 증발(Korea JoongAng Daily 2026-06-08).
- Broadcom 주가 **-7.92%** 추가 하락. 美 반도체주 동반 급락: 엔비디아 -6.2%, 마이크론 -13.25%. (연합뉴스 2026-06-08)
- **4대 악재**: ①국제유가 급등 ②미국 금리인상 우려(10년물 4.5%+) ③환율 1,560원 급등 ④외국인 대규모 매도. (포춘코리아 2026-06-08)

### 💰 캐시 우드(ARK Invest), 약세장에서 Broadcom 매수
- ARK Invest(캐시 우드)가 6/5~8 Broadcom **14,190주**를 매수했다고 공개(coinreaders.com). 메타(META) 40,078주도 함께 매수.
- '남들이 던질 때 줍는' 전략으로, 장기 AI 반도체 수요에 베팅하는 행보로 해석.

### 📰 IT동아 주간 요약
- IT동아(2026-06-08): Broadcom Q2 FY2026 실적 리뷰 — "분기 총매출 221억 8,700만 달러, AI 반도체 성장세 지속 확인했으나 시장 기대치에 미달한 가이던스가 폭락 촉발". (it.donga.com)
...
## 2026-06-09 업데이트 — 美 증시 반등·Marvell S&P 500 편입·AI 인프라 패러다임 분석

### 📈 美 증시 반등 (2026-06-08 마감)
- SOX +5.61% 강한 반등. Micron +9.87% 급등은 메모리 섹터 강한 수요 신호. Broadcom +2.82% 반등, Nvidia +1.73%, AMD +5.14%, TSMC +2.8%. (네이버블로그 dogokdongja 2026-06-09)
- 나스닥 반도체 반등 중심 — 지난주 Broadcom 쇼크 이후 기술적 반발 매수 유입. 다만 거래량은 평균 하회해 추격성 자금 유입은 절제된 모습. (네이버블로그 minggong2- 2026-06-09)
- 시사점: HBM4·DRAM ASP 상승세 재확인, 메모리 섹터 수요 견조 신호. (네이버블로그 dogokdongja)

### 🆕 Marvell Technology (MRVL), S&P 500 편입 소식에 급등
- **6/8 Marvell S&P 500 편입 발표**, 주가 급등. 젠슨 황 CEO가 Marvell 성장 가능성을 긍정적으로 언급한 점도 시장 관심 집중. (네이버블로그 lhjas 2026-06-09)
- **Marvell vs Broadcom 비교 분석 확산** (네이버블로그 murmurain 2026-06-09):
  - Broadcom: 시총 약 $1.8T, 핵심 강점 = 빅테크 맞춤 칩 파트너(Google TPU·Meta MTIA), PER ~40배
  - Marvell: 시총 약 $250B, 핵심 강점 = 광통신 연결·네트워크 반도체, PER ~34배
  - 두 회사 모두 AI 데이터센터 인프라 수혜주이나, Marvell은 상대적으로 저평가 구간

### 🔄 AI 인프라 패러다임 시프트: '연산→통신' (네이버블로그 hyungmjee 2026-06-09)
- AI 인프라 시장의 무게중심이 GPU 컴퓨팅(Compute)에서 데이터센터 내부/외부 연결(Connect)로 이동
- Broadcom이 직면한 구조적 도전: 맞춤형 ASIC 시장에서 Marvell 추격, 광통신 분야 경쟁 심화
- AI 칩이 월가의 담보물로 활용되는 구조 — FT 보도에 따르면 약 300억 달러 규모 담보 거래에 Broadcom 지원 포함. (네이버블로그 waryang 2026-06-09)

### 🔍 AI 병목 — 전력 인프라 (네이버블로그 bluegirl0905 2026-06-09)
- "AI 진짜 병목은 전력" — AIPO ETF(AI+전력인프라) 주요 편입 종목: Broadcom·NVIDIA·AMD·Quanta Services·Vertiv·GE Vernova·Eaton·Bloom Energy·Cameco
- AI 데이터센터 전력 소비 급증이 전력 인프라 투자 수요로 연결
- AIPO ETF 운용보수 0.69%로 다소 높은 편.

### 🐦 SNS·블로그 인사이트 (2026-06-08~09)
- 🐦네이버블로그(bloomingdreamer, 2026-06-09): "브로드컴 12% 급락의 충격 — AI 반도체 거품론 재점화?" — Broadcom 가이던스 실망이 AI 반도체 전체 수급 악화 촉매. ⚠️개인 분석.
- 🐦네이버블로그(pjjyy1010379, 2026-06-09): "브로드컴(AVGO) 2026년 6월 분석: 지금이 매수 기회일까?" — 신규 투자자 대상 Broadcom 핵심 정보 정리. ⚠️개인 분석.
- 🐦네이버블로그(hdmin77, 2026-06-09): "미국 증시 프리뷰 — 반도체 반등" — SpaceX IPO 전후 Nvidia·Broadcom 등 AI·우주 테마 연동 종목 수급 변동 주목. ⚠️개인 분석.
- 🐦네이버블로그(estislow, 2026-06-09): "카페에서도, 유튜브에서도 모두가 이 말을 하기 시작하면" — Broadcom 실적 발표와 젠슨 황 방한이 주요 테크 이벤트로 분석. ⚠️개인 분석.


## 2026-06-08 업데이트 — AI 칩 담보 거래 관련 Broadcom
...
## 2026-06-10 업데이트 — Anthropic AI 인프라 350억 달러 펀드·CPI 경계 속 재약세

### 💰 Broadcom·Apollo·Blackstone, Anthropic AI 인프라 350억 달러 펀드 출범
- Apollo Global Management·Blackstone·Broadcom이 [[Anthropic]]의 AI 컴퓨팅 인프라 확장에 약 **350억 달러(약 48조 원)** 규모 지원 계획 발표. (WSJ 2026-06-09, Newspim 인용)
- Broadcom의 맞춤형 AI 칩과 네트워킹 솔루션이 핵심 인프라로 채택. AI 모델 경쟁에서 **데이터센터 인프라 자체가 핵심 자원**으로 부상하는 시그널. (네이버블로그 jarita113 2026-06-09)
- 이 프로젝트: Broadcom 칩 + 네트워킹 → Anthropic 컴퓨팅 → Apollo·Blackstone 자금 조달 구조.

### 📉 6/9 美 증시 재약세 — Broadcom -1.12%, SOX -1.93%
- 6/8 강한 반등(+2.82%) 하루 만에 다시 약세. Broadcom 383.09(-1.12%), Nvidia -1.93%, AMD -6.56% 급락. Micron +1%→-1% 하회. (초이스뉴스 2026-06-09, 한국경제TV 2026-06-09)
- SOX -1.93%로 반등분 일부 반납. 투자심리가 'AI 수요 견조'라는 말만으로 만족하지 못하고, **구체적 증명(성장 속도·고객사 확대·마진)**을 요구하는 국면 지속.
- **핵심 변수**: 6/10 CPI(헤드라인 4.2% 예상), 6/16~17 FOMC가 단기 방향 결정. 고금리 환경에서 높은 PER(42.8배) 주식의 멀티플 부담은 여전. (네이버블로그 ksb8435 2026-06-09)

### 🇰🇷 코스피·반도체주 6/10 재급락
- **코스피 4.52% 급락(7,730.82)**: 외국인 2조8,042억·기관 1조5,627억 동반 순매도. 장중 매도 사이드카 발동. 삼성전자 -6.99%, SK하이닉스 -9.26% 급락. (아카이브 네이버블로그 archi-so 2026-06-09)
- 외국인 22거래일 연속 순매도. 환율(1,524원) 부담 속 매도세 진정되지 않음.

### 🐦 SNS·블로그 관점 (2026-06-09~10)
- 🐦네이버블로그(skydreamingdee, 2026-06-09): "Broadcom 시장 예상치 하회 가이던스. 맞춤형 AI 칩 시장 Broadcom 60%·Marvell 20% 수준." (https://blog.naver.com/skydreamingdee/224311467668) ⚠️개인 분석.
- 🐦네이버블로그(sgpjb1, 2026-06-09): "CPO 도입 지연 논란에도 Broadcom·Marvell 장기 수혜. 광통신 밸류체인 전반 분석." (https://blog.naver.com/sgpjb1/224311470801) ⚠️개인 분석.
- 🐦네이버블로그(gaajur, 2026-06-09): "Google TPU v8, Broadcom·MediaTek 이원화 양산 체제. 단일 칩 공정 폐기." (https://blog.naver.com/gaajur/224311572033) ⚠️개인 분석.
- 🐦네이버블로그(joy014, 2026-06-09): "AI 수익성 논쟁 재점화. Broadcom·Apollo·Blackstone 350억 달러 프로젝트는 AI 인프라 투자 지속 확인." (https://blog.naver.com/joy014/224311751254) ⚠️개인 분석.
- 🐦네이버블로그(chickenstocktv, 2026-06-09): "Lumentum Mizuho 컨퍼런스 — Broadcom·NVIDIA는 TSMC 공정 사용. 설계·공정 분리 구조." (https://blog.naver.com/chickenstocktv/224311709782) ⚠️개인 분석.
...
### 2026-06-10 업데이트 — CPI 안도·중동 긴장 재고조·SMCI 390억 달러 주문

#### 미국 5월 CPI 발표 — 헤드라인 4.2%, 근원 3.4% 예상 부합 (디지털데일리 2026-06-10)
- **美 5월 CPI 헤드라인 4.2%**(전년비, 3년 만 최고). 근원 CPI 3.4%로 예상 부합. 시장 '최악은 피했다' 단기 안도.
- **3대 지수 하락 마감**: 다우 -0.7%, S&P500 -0.5%, 나스닥 -0.9%. SOXX 3%+ 하락. Broadcom·AMD·Micron 5거래일 중 4거래일 하락. (디지털데일리 2026-06-10)
- **중동 긴장 재고조**: CPI 안도감을 상쇄. 국제유가 변동성 확대, 지정학적 리스크 부담.
- 반도체 관련 시사점: 근원 CPI 예상 부합 → 금리인상 우려 단기 완화 → 성장주 밸류에이션 부담 경감. 단, 헤드라인 4.2% 고물가 시그널 유지로 AI·반도체 전반의 불확실성 해소 불완전.

#### SMCI 390억 달러 AI 서버 주문·추가 급락 — Broadcom·Marvell 연관 (블로그 uc73 2026-06-10)
- **SMCI, 390억 달러 규모 AI 서버 주문 수주** 발표에도 불구 주가 5거래일 중 4일 하락. 시장은 '수주 규모'보다 '고객 다각화·마진·한계 M/S'에 주목.
- **Broadcom·Marvell·Arista** 등 네트워크·스위칭 반도체 수요는 SMCI 주문과 무관하게 AI 데이터센터 구축 수요 중간~높음 유지. 개별 악재와 분리 필요.
- **Vertiv·Schneider Electric** 전력·냉각 분야도 AI 데이터센터 구축 수혜, 다만 밸류에이션에 이미 일부 반영.
- SMCI 사례가 시사하는 점: AI 서버·인프라 분야에서도 '큰 수주'만으로 주가가 방어되지 않는 국면 진입. 수익성·경쟁력·성장 속도의 구체적 증명이 필요.

#### 'AI 치트키 시대 끝' — 밸류에이션 재평가 국면 (블로그 머니대디 2026-06-10)
- 브로드컴(Broadcom) 실적·가이던스 쇼크를 기점으로 **그동안 美 증시를 하드캐리했던 AI 치트키가 가혹한 시험대에 올랐다**는 분석.
- AI 주식 전반: 높은 밸류에이션에 기대 성장률이 '기대치를 상회해야만' 주가 유지되는 구조. 기대치에 미달하면 단기 급락. Broadcom·Apple을 포함한 고평가 AI 종목들의 '현실 자각 타임'으로 평가.
- Apple도 같은 맥락에서 밸류에이션 부담 논란.

#### 출처
- 머니대디 네이버블로그 (2026-06-10): [주식시장 왜 이래?](https://blog.naver.com/jasonmoneylogin/224312474780) ⚠️개인 분석
- uc73 네이버블로그 (2026-06-10): [SMCI 급락 390억 달러 AI 서버 주문 분석](https://blog.naver.com/ucs73/224312477281) ⚠️개인 분석
- 디지털데일리 (2026-06-10): [美 5월 CPI 안도했지만 중동 긴장 재고조…뉴욕증시 3대 지수 하락](https://www.ddaily.co.kr/page/view/2026061105234619111)

⚠️블로그 자료는 개인 분석·참고용으로 셀사이드 리포트와 신뢰도 차이 있음.


| 2026-06-10 | Broadcom -5.12%($372) 추가 하락, 5거래일 중 4일 하락 기록. 5월 CPI 헤드라인 4.2%(3년 만 최고)·중동 전운·SMCI -23.1% 폭락 동시 충격. 반도체 인프라 전반의 밸류에이션 조정 심화. (dogokdongja·sjsori 2026-06-10) |
